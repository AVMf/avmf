...
public class Calendar {
  ...
  public static int daysBetween(
      int start_month, int start_day, int start_year, int end_month, int end_day, int end_year) {
    int days = 0;
    ...
    if (end_day > monthDays(end_month, end_year)) end_day = monthDays(end_month, end_year);
