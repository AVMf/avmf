...
public class TestControlDependencies {
    ...
    public void testGetControlDependenceChain() {
        ...
        depChain = DEPS.getControlDependenceChain(new Branch(5, false));
        ...
        depChain = DEPS.getControlDependenceChain(new Branch(6, true));
        ...
        assertEquals("2nd element of chain for 6T should beb ranch 1F", "1F", depChain.branches.get(1).toString());
    }
}
